...
class KillInterruptionHandler(AbstractInterruptionHandler):
    ...
    def execute(self, irq):
        ...
        #Se toma el siguiente en readyQueue y con el if se verifica que sea 
        # distinto de None y lo pone a correr
...
class IoOutInterruptionHandler(AbstractInterruptionHandler):
    ...
    def execute(self, irq):
        ...
        #Una vez se finaliza I/O se pregunta si hay alguien
        #corriendo en CPU, else se carga en CPU
